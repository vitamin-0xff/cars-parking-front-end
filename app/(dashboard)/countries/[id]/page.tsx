    ...
    return (
        <main className="p-6">
            <div className="flex flex-col gap-2 w-full">
                ...
                {data &&
                <PageHeader title="Country" subtitle="Country details here" onEditRequest={() => navigator.push(`/countries/${data.id}/edit`)} />
                }
                </div>
            <div className="mt-6">
                <Card>
                            ...
                            !isLoading && !error && data && (
                                <div className="flex flex-col gap-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <KeyValueView keyT="ISO Code" value={data.isoCode} />
